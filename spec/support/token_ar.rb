...
class TokenAR
  ...
  attr_reader :encrypted_access_token, :encrypted_refresh_token, :expires_at, :portal_id

  def initialize(encrypted_access_token: nil, encrypted_refresh_token: nil, expires_at: nil, portal_id: nil)
    ...
    @portal_id = portal_id || 4738746
  end

  def update(encrypted_access_token:, encrypted_refresh_token:, expires_at:, portal_id:)
